...
import css from './styles/pokecard.css';
import Bgcard from './styles/BackGroundCard.css';
    ...
    return (
        ...
        >
            <div className='card_poke'>
                <header
                    className={`card_header bg-${poke?.types[0].type.name}`}
                >
                    <img
                        className='card_img'
                        src={
                ...
                <div className='card_content'>
                    <h2
                        className={`card_name color-${poke?.types[0].type.name}`}
                    >
                        {poke?.name}
                    </h2>
