...
import pokeinfo from './style/pokeinfo.css';
import Bgcss from '../components/styles/BackGroundCard.css';
import { useNavigate, useParams, Link } from 'react-router-dom';
import Swal from 'sweetalert2';
import Header from '../shared/Header';
import BgColor from '../data/BgColor';
import { motion } from 'framer-motion';
import imgpokemon from '../img/Time.webp';

const Pokeinformation = () => {
    const { id } = useParams();

    //se guardara el tipo de pokemon
    const [type, setType] = useState('');


    // se guardara toda la informacion del pokemon
